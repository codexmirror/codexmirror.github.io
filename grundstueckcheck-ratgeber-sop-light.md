...
• abstrakte Aussagen möglichst in konkrete Fragen oder Beispiele übersetzen
...
Sprachlogik (verbindlich)

Ratgebertexte müssen so formuliert sein, dass ein Laie sie sofort versteht.
...
Unklare oder stark juristische Begriffe sollen nicht isoliert verwendet werden.
Wenn sie notwendig sind, müssen sie direkt erklärt oder vereinfacht werden.

Ziel:
Der Nutzer soll sich seine eigene Situation bildlich vorstellen können.
...
• Sind wichtige Begriffe verständlich erklärt oder in Alltagssprache übersetzt?
• Kann sich ein Laie die beschriebene Situation konkret vorstellen?
...
Typische Verbesserungen sind:
	•   Fachbegriffe verständlicher erklären oder in alltagsnahe Sprache übersetzen
	•	Beispiele konkreter machen
	•	Entscheidungsfaktoren klarer darstellen
	•	FAQ näher an realen Suchfragen formulieren
	•   abstrakte Aussagen in konkrete, nachvollziehbare Beispiele oder Fragen umformulieren
...
Artikel liefern verständliche Orientierung –
so, dass Nutzer ihre eigene Situation wiedererkennen.
